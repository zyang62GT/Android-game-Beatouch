...
public class TutorialScreen3 implements Screen {
    ...
    private Texture texture = Assets.page3Texture;
    ...
    public void render(float delta) {
        ...
        Gdx.input.setInputProcessor(new SimpleDirectionGestureDetector(new SimpleDirectionGestureDetector.DirectionListener() {
            ...
            @Override
            public void onRight() {
                ((Game) Gdx.app.getApplicationListener()).setScreen(new TutorialScreen4());
            ...
            public void onLeft() {
                ...
                ((Game) Gdx.app.getApplicationListener()).setScreen(new TutorialScreen2());
