 ...
 */
public class TutorialScreen4 implements Screen {
    Stage stage = new Stage();
    private Texture texture = Assets.page4Texture;
    ...
    public void render(float delta) {
        ...
        Gdx.input.setInputProcessor(new SimpleDirectionGestureDetector(new SimpleDirectionGestureDetector.DirectionListener() {
            ...
            @Override
            public void onRight() {
                ((Game) Gdx.app.getApplicationListener()).setScreen(new TutorialScreen5());
