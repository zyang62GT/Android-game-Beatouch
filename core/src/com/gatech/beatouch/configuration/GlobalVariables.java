package com.gatech.beatouch.configuration;
...
public class GlobalVariables {
    ...
    public static void loadConfiguration() {
        ...
        sortMode = prefs.getInteger("sorting_mode", SongUtilities.SORTING_MODE_SONG_NAME);
        sortOrder = prefs.getInteger("sorting_order", SongUtilities.SORTING_MODE_ASCENDING);
        syncMode = prefs.getInteger("sync_mode", SongUtilities.SYNC_MODE_1);
